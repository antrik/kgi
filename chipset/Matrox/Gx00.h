...
**
**	$Id: Gx00.h,v 1.3 2003/01/15 23:21:51 ortalo Exp $
*/
...
/* AGP things as specified by the manual INCOMPLETE! */
/* NB: these one could be accessed via the indirections list of PCI
 * extension. These are only the published values.
 */
#define MGAG_AGP_CMD    0xF8
#define MGAG_AGP_CMD_AGP_ENABLE   (1 << 8)
#define MGAG_AGP_IDENT  0xF0
#define MGAG_AGP_STS    0xF4
