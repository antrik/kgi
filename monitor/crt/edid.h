/* From XFree86: xc/programs/Xserver/hw/xfree86/ddc/edid.h,v 1.7 2000/04/20 21:28:26 tsi Exp */
...
#define SECTION(x,y) ((kgi_u8_t *)(x + y))
#define GET_ARRAY(y) ((kgi_u8_t *)(edid_data + y))
#define GET(y) (*(kgi_u8_t *)(edid_data + y))
...
typedef kgi_u_t Uint;
typedef kgi_u8_t Uchar;
...
struct disp_features {
  kgi_u_t input_type:1;
  kgi_u_t input_voltage:2;
  kgi_u_t input_setup:1;
  kgi_u_t input_sync:5;
  kgi_s_t hsize;
  kgi_s_t vsize;
  float gamma;
  kgi_u_t dpms:3;
  kgi_u_t display_type:2;
  kgi_u_t msc:3;
  float redx;
  float redy;
  float greenx;
...
struct detailed_timings {
  ...
  kgi_s_t v_blanking;
  kgi_s_t h_sync_off;
  kgi_s_t h_sync_width;
  kgi_s_t v_sync_off;
  kgi_s_t v_sync_width;
  kgi_s_t h_size;
  kgi_s_t v_size;
  kgi_s_t h_border;
  kgi_s_t v_border;
  kgi_u_t interlaced:1;
  kgi_u_t stereo:2;
  kgi_u_t sync:2;
  kgi_u_t misc:2;
};
